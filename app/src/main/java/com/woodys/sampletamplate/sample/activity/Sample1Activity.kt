...
class Sample1Activity : ToolBarActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layout.setEnableLog(true)

        val mData = arrayOf("Java", "C++", "Python", "JavaScript", "Ruby", "Swift","Mockito mocking parameterized class in Kotlin","That is because Kotlin's class literal syntax is runtime reference. Since generic type arguments are not reified at runtime, we can only obtain an object representing a class, not a type.You can declare a helper function which substituting parameterized class with the desired type at the call site:")
